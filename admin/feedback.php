               ...
               <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-10" style="padding-top: 50px;">
                      <h2 style="padding-bottom: 20px;">Feedback Inquiries</h2>
                      <table class="table table-bordered table-striped table-responsive" style="width:100%">
                        ...
                        while ($data = $result->fetch_object()) {
                          echo "<tr>";
                            echo "<td> $data->id";
                            echo "<td> $data->f_name";
                            echo "<td> $data->f_email";
                            echo "<td> $data->f_rating";
                            echo "<td> $data->f_sugg";
                            echo "<td>";
                            echo " <a href='delete.php?id=$data->id' type='button' class='btn btn-danger'>Delete</a>";
                            echo "<td>";
                          echo "</tr>";
                        }
