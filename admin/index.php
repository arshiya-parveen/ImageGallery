    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <!--   dashboard section -->
            ...
            <div class="col-md-10">
              <div class="row">
                <h1 style="padding: 20px 20px;">Dashboard</h1>
                <div class="jumbotron">
                  <div class="row w-100">
                          <div class="col-md-4 thumbnail">
                              <div class="card border-info mx-sm-1 p-3">
                                  <div class="card border-info shadow text-info p-3 my-card" ><img src="img/ga.gif" alt="" width="50" height="50"></div>
                                  <div class="text-info text-center mt-5"><h2>Total Image Upload</h2></div>
                                  <div class="text-info text-center mt-2"><h1>234</h1></div>
                              </div>
                          </div>
                          <div class="col-md-4 thumbnail">
                              <div class="card border-success mx-sm-1 p-3">
                                  <div class="card border-success shadow text-success p-3 my-card"><img src="img/ge.gif" alt="" width="50" height="50"></div>
                                  <div class="text-success text-center mt-3"><h2>Total Feedback</h2></div>
                                  <div class="text-success text-center mt-2"><h1>9332</h1></div>
                              </div>
                          </div>
                          <div class="col-md-4 thumbnail">
                              <div class="card border-danger mx-sm-1 p-3">
                                  <div class="card border-danger shadow text-danger p-3 my-card" ><img src="img/go.gif" alt="" width="50" height="50"></div>
                                  <div class="text-danger text-center mt-3"><h2>Total contact</h2></div>
